...
export function textureShape(sampling){return {dimension:sampling==='tex3D'?'3d':'2d',format:sampling==='tex2Duchar'?'r8uint':sampling==='fetch_uint'?'r32uint':(sampling==='tex1D'||sampling==='tex2Dfloat4')?'rgba32float':sampling==='tex2D'?'r32float':'r8unorm'};}
