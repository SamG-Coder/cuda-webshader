...
export function textureShape(sampling){return {dimension:sampling==='tex2DLayered'?'2d-array':['tex3D','tex3Dfloat4'].includes(sampling)?'3d':'2d',format:sampling==='tex2Duchar'?'r8uint':sampling==='fetch_uint'?'r32uint':(sampling==='tex3Dfloat4'||sampling==='tex1D'||sampling==='tex2Dfloat4'||sampling==='tex2DLayered')?'rgba32float':sampling==='tex2D'?'r32float':'r8unorm'};}
