...
export async function meshPreview({owner,container,plan,runtime,...options}){
 ...
 const material=owner.material=new THREE.MeshStandardNodeMaterial({color:0x85e8cf,roughness:.45,metalness:.1,side:THREE.DoubleSide});
