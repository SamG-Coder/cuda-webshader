...
export function suggestConfig(artifact){
 ...
 const values=Object.fromEntries(scalars.map(s=>[s.name,s.sourceType==='bool'?0:s.sourceType==='cw_uchar4'?0:s.defaultValue!==undefined?s.defaultValue:({n:65536,n4:16384,width:256,height:256,M:64,N:64,K:64,a:0.5,dt:0.016,time:0,attraction:1})[s.name]??(s.type==='f32'?1:256)]));
