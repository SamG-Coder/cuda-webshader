...
for(const file of ['cases.js','convolution-separable-reference.js','fdtd3d-reference.js','nbody-reference.js','gpu-suite.js','three-interop.js','gpu.html','gpu-page.js'])await copyFile(new URL(`tests/${file}`,root),new URL(`tests/${file}`,out));
for(const file of await readdir(new URL('tests/',root)))if(/\.(cu|cuh)$/.test(file))await copyFile(new URL('tests/'+file,root),new URL('tests/'+file,out));
...
for(const file of ['performance-comparison.html','performance-comparison.md','comparison-summary.json','simplegl-showcase.png','live-app.png','nvidia-audit.json','nvidia-audit.md','nvidia-gpu.json','nvidia-native.json','nvidia-transpose.json','nvidia-transpose-native.txt','nvidia-scalar.json','nvidia-scalar-native.txt','nvidia-blackscholes.json','nvidia-blackscholes-native.txt','nvidia-matrixmul.json','nvidia-matrixmul-native.txt','nvidia-scan-update.json','nvidia-scan-update-native.txt','nvidia-atomic-cas.json','nvidia-atomic-cas-native.txt','nvidia-aligned-copy.json','nvidia-aligned-copy-native.txt','nvidia-fwt-pass.json','nvidia-fwt-pass-native.txt','nvidia-fwt-shared.json','nvidia-fwt-shared-native.txt','nvidia-histogram-merge.json','nvidia-histogram-merge-native.txt','convolution-separable-sandbox.png','convolution-separable-sandbox-check.json','convolution-separable-native.txt','fdtd3d-sandbox.png','fdtd3d-sandbox-check.json','fdtd3d-native.txt','nbody-sandbox.png','nbody-sandbox-check.json','nvidia-regression-gpu.json','nbody-integrate-native.txt','shared-wrapper-native.txt','vector-initializers-native.txt','helper-pointers-native.txt','shared-helpers-native.txt','constant-globals-native.txt','type-traits-native.txt','helper-templates-native.txt','nvidia-bitonic.json','nvidia-bitonic-native.txt','nvidia-driver-add.json','nvidia-driver-add-native.txt','nvidia-mpi-sqrt.json','nvidia-mpi-sqrt-native.txt','nvidia-inverse-cnd.json','nvidia-inverse-cnd-native.txt']){
