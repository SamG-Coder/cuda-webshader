...
for(const file of ['index.html','src','kernels','showcases','LICENSE','THIRD_PARTY_NOTICES.md','licenses'])await cp(new URL(file,root),new URL(file,out),{recursive:true});
...
for(const file of ['performance-comparison.html','performance-comparison.md','comparison-summary.json']){
